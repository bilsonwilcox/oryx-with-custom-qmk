...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    KC_LEFT_GUI,    KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,                                           KC_N,           KC_M,           KC_COMMA,       KC_DOT,         KC_SLASH,       KC_ENTER,       
                                                    TD(DANCE_1),    MT(MOD_LCTL, KC_TAB),                                KC_LEFT_SHIFT,  MO(2)
  ),
  [1] = LAYOUT_voyager(
  ...
  [2] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, LALT(LSFT(KC_MINUS)),KC_MS_BTN2,     DUAL_FUNC_3,    KC_MS_BTN1,     KC_BSPC,                                        DUAL_FUNC_5,    KC_LEFT,        KC_DOWN,        KC_RIGHT,       KC_MEDIA_PLAY_PAUSE,KC_AUDIO_VOL_DOWN,
  ...
  [4] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, ST_MACRO_2,     LALT(KC_F4),    ST_MACRO_3,     ST_MACRO_4,     DUAL_FUNC_2,                                    LCTL(LSFT(KC_H)),KC_TRANSPARENT, RGB_SPD,        RGB_SPI,        DUAL_FUNC_4,    KC_AUDIO_MUTE,  
    KC_TRANSPARENT, RALT(KC_RIGHT_CTRL),LALT(KC_Q),     ST_MACRO_5,     ST_MACRO_6,     KC_BSPC,                                        DUAL_FUNC_5,    KC_TRANSPARENT, RGB_HUD,        RGB_HUI,        KC_MEDIA_PLAY_PAUSE,KC_AUDIO_VOL_DOWN,
...
const uint8_t PROGMEM ledmap[][RGB_MATRIX_LED_COUNT][3] = {
    ...
    [4] = { {140,69,242}, {0,255,255}, {0,255,255}, {0,255,255}, {92,255,255}, {151,145,255}, {0,255,255}, {44,255,255}, {0,255,255}, {83,255,255}, {133,142,240}, {83,255,255}, {0,0,0}, {142,163,255}, {83,255,255}, {21,255,255}, {0,0,0}, {26,255,255}, {0,0,0}, {123,254,255}, {0,0,0}, {0,0,0}, {86,255,255}, {0,255,255}, {0,255,255}, {0,255,255}, {0,140,253}, {0,0,0}, {0,255,255}, {0,255,255}, {0,245,245}, {134,255,204}, {251,255,186}, {21,255,255}, {0,255,255}, {0,255,255}, {25,218,204}, {251,255,186}, {41,255,255}, {21,255,255}, {0,255,255}, {0,255,255}, {25,218,204}, {134,255,204}, {76,255,255}, {83,255,255}, {0,255,255}, {0,255,255}, {25,218,204}, {0,255,255}, {0,255,255}, {0,255,255} },
